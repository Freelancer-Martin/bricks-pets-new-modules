...
class Extra_Element_Testimonials extends Element {
    public $category     = 'custom';
    public $name         = 'testimonials-extra';
    ...
    public function get_label() {
        return esc_html__( 'Extra Testimonials', 'bricks' );
    }

    public function enqueue_scripts() {
        wp_enqueue_script( 'bricks-swiper' );
        wp_enqueue_style( 'bricks-swiper' );
        wp_enqueue_style('testimonial-extra', get_stylesheet_directory_uri() . '/css/testimonial-extra.css', false);
            ...
            <div <?php echo $this->render_attributes( 'swiper' ); ?>>
                <div class="swiper-wrapper">
                    ...
                    foreach ( $testimonials as $index => $testimonial ) {
                        ...
                        echo '<div class="slide-left-container" >';
                            ...
                            if ( isset( $testimonial['image'] ) ) {
                                if (!empty($testimonial['image'])) {
                                    ...
                                    if ($this->lazy_load()) {
                                        ...
                                        echo '<img class="image css-filter" src="' . esc_url($url) . '" />';
                                    } else {
                        ...
                        if ( isset( $testimonial['name'] ) || isset( $testimonial['title'] ) || isset( $testimonial['image'] ) ) {
                            ...
                            if ( isset( $testimonial['name'] ) || isset( $testimonial['title'] ) ) {
                                ...
                                if ( isset( $testimonial['name'] ) ) {
                                    $this->set_attribute( "name-$index", 'class', [ 'extra-testimonial-name' ] );
