...
class Post_Widget_Element extends Element
{
    public $category = 'custom';
    public $name = 'post-widget';
    ...
    {
        return esc_html__('Posts Widget', 'bricks');
    }
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_style('post-widget', get_stylesheet_directory_uri() . '/css/post-widget.css', false);
    ...
    public function render()
    {
        ...
        echo '<div class="post-widget-wrapper">';

        $item_classes = ['post-widget-item', 'swiper-slide'];
        ...
        foreach ($woocommerce_filtered_array as $item_index => $item) {
            ...
            if(  ! empty($item['post_title']) ) {
                ...
                echo '<a href="' . $item['post_link'] . '"><div class="post-widget-container" >';
                echo '<div class="post-widget-date">' . $item['post_date'] . '</div>';
                //echo '<img class="post-img" src="' . $item['post_img'] . '" />';
                echo '<p class="post-widget-title" >' . $item['post_title'] . '</p>';
